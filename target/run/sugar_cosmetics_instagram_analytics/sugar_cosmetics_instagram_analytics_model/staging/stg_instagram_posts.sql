  ...
  create view "sugar_cosmetics_instagram_analytics"."public"."stg_instagram_posts__dbt_tmp"
...
FROM "sugar_cosmetics_instagram_analytics"."public_raw_instagram"."posts"
  );